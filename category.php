...
<?php 
    ...
    $sql = "SELECT * FROM tbl_category where delete_status != 1";
    ...
    $i=1;
      ...
      ?>
        <tr>
            ...
            <td>
              <a href="category_edit.php?editid=<?=$row['id'];?>"class="btn btn-xs btn-primary"><i class="feather icon-edit m-t-10 f-16 " ></i></a>
              <a href="category_delete.php?id=<?=$row['id'];?>"class="btn btn-xs btn-danger"><i class="feather icon-trash-2 m-t-10 f-16 " ></i></a>
            </td>
        </tr>
    <?php  $i++;} 
?>
