...
$confirm =  hash('sha256', $salt . $confirm_new);
  ...
  if($db_pass!=$old_pass){ ?> 
    <?php $_SESSION['error']='Old password does not matched';?>

  <?php } else if($new_pass!=$confirm){ ?> 
    <?php $_SESSION['error']='New password and Confirm password does not matched';?>
  <?php } else {
if($_SESSION["username"]=='admin' || $_SESSION["username"]=='user'){
...
<li class="breadcrumb-item"><a href="change_password.php">Change Password</a>
</li>
</ul>
</div>
</div>
